/* GET NEXT VAL AUTO_INCREAMENT */
-- DROP PROCEDURE IF EXISTS INCREASE_SEQUENCE;
-- DELIMITER //
-- CREATE PROCEDURE INCREASE_SEQUENCE (
-- 	IN 	IN_SCHEMA 	VARCHAR(100),
-- 	IN 	IN_TABLE  	VARCHAR(100),
--     OUT	OUT_SEQ 	INT,
...
-- 		SET OUT_RESULT := CONCAT('ERROR -> ON [INCREASE_SEQUENCE] ',  @SQL_STATUS, ' - ', @ERR_MSG);
-- 	END;    
--     SET OUT_RESULT = 'OK';
    
-- 	SELECT 
-- 		AUTO_INCREMENT INTO OUT_SEQ
--     FROM 
...
--     SET OUT_SEQ = OUT_SEQ + 1;    
--     SET @ALTER_QUERY = CONCAT('ALTER TABLE ', IN_SCHEMA, '.', IN_TABLE, ' AUTO_INCREMENT = ', OUT_SEQ);	    
    
--     SELECT @ALTER_QUERY;
    
--     PREPARE alterTableStmt FROM @ALTER_QUERY;
--     EXECUTE alterTableStmt;
--     DEALLOCATE PREPARE alterTableStmt;
-- END //
-- DELIMITER ;	

-- /* GET NEXT VAL AUTO_INCREMENT  */
-- DROP FUNCTION IF EXISTS GET_NEXT_VAL;
-- DELIMITER //
-- CREATE FUNCTION GET_NEXT_VAL(
-- 	IN_SCHEMA 	VARCHAR(100),
-- 	IN_TABLE  	VARCHAR(100)    
-- ) RETURNS INT 
-- DETERMINISTIC 
-- BEGIN
-- 	DECLARE VL_NEXT_VAL INT DEFAULT 0;
--     DECLARE VL_RESULT VARCHAR(500);
-- 	DECLARE CONTINUE HANDLER FOR SQLEXCEPTION 
--     BEGIN 
-- 		SET VL_NEXT_VAL = NULL;
--     END;    
--     CALL INCREASE_SEQUENCE(IN_SCHEMA, IN_TABLE, VL_NEXT_VAL, VL_RESULT);
--     RETURN VL_NEXT_VAL;
-- END //
-- DELIMITER ;
