...
CREATE TABLE DEVICE (
	...
	CONSTRAINT PK_DEVICE PRIMARY KEY (DEVICE_ID ASC)
);


ALTER TABLE DEVICE ADD CONSTRAINT UQ_NAME UNIQUE (NAME);
ALTER TABLE DEVICE ADD CONSTRAINT FK_ACCESS_LEVEL_DEVICE FOREIGN KEY (ACCESS_LEVEL_ID) REFERENCES ACCESS_LEVEL (ACCESS_LEVEL_ID);

/* CHECADAS Y TARJETA */ 
ALTER TABLE CARD ADD COLUMN EMPLOYEE_ID INT;
ALTER TABLE CARD ADD CONSTRAINT UQ_NUMBER UNIQUE (NUMBER, EMPLOYEE_ID);
...
ALTER TABLE CARD_CHECK ADD COLUMN DEVICE_ID INT NOT NULL;

ALTER TABLE CARD_CHECK ADD CONSTRAINT FK_DEVICE FOREIGN KEY (DEVICE_ID) REFERENCES DEVICE(DEVICE_ID);
